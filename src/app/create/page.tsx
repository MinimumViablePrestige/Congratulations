        ...
        <section className={styles.lead}>
          <div className={styles.intro}>
            ...
            <p className={styles.subtitle}>
              Теперь мы не привязываем создание к жесткому справочнику вроде “учитель / воспитатель / коллега”.
              Организатор задает живой повод своими словами, выбирает визуальный формат и сразу получает рабочие
              ссылки.
            </p>
          </div>
          ...
          <div className={styles.tipCard}>
            ...
            <ul>
              ...
              <li>Зафиксированы 4 универсальных визуальных шаблона первой версии.</li>
            </ul>
          </div>
        </section>
